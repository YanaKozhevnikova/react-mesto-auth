  ...
  return (
    <div className="auth">
      ...
      <form onSubmit={handleSubmit} name="signin" className="form">
        ...
        <input value={password} onChange={handlePasswordChange} type="text" required minLength="2" maxLength="40" placeholder="Пароль" name="password" id="password-input" className="form__input form__input_type_auth" />
